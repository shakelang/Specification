...
const settings = {
  title: "CommonIO API",
  tagline: "Common IO and Streaming api for KMP 🚀",
  description:
    "CommonIO is a kotlin-multiplattform library for work with IO and Streaming on all platforms.",
  ...
  return (
    <header className={clsx("hero hero--primary", styles.heroBanner)}>
      <div className="container">
        ...
        >
          <a
            href="https://dokka.shakelang.com/util/common-io/"
            style={{
