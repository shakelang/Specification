...
<ManualSection opcode="0xB1" id="7.2" name="invoke_instance" level="4" />
...
<ManualSection opcode="0xB3" id="8.2" name="load_field_instance" level="4" />
...
<ManualSection opcode="0xB9" id="8.8" name="store_instance" level="4" />
