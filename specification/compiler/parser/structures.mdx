...
A constructor declaration is a sequence of tokens that declare a constructor. It consists of an optional access modifier,
the constructor keyword, optionally a name, a list of parameters and a body.
